...
# Intended for tmux:
#   tmux new -s paper_50salads_fold1_beam1000_switch0 scripts/run_eval_diffact_50salads_fold1_w7_taucap8_beam1000_switch0.sh
set -euo pipefail

cd /home/dsi/eli-bogdanov/sktr_for_long_traces

OUT="results/paper_diffact_50salads_fold1_w7_taucap8_beam1000_switch0_topm1_topk3_chunk11"
mkdir -p "$OUT"
