#!/usr/bin/env python3
"""Prepare the immutable OOF-only agreement screening phase for repair-head v3."""
...
def prepare(args: argparse.Namespace) -> Path:
    ...
    config = {
        ...
        "governance": {
            ...
            "mechanism_novel_not_threshold_tuning": True,
            "failed_mechanism_gate_closes_line_without_outer": True,
            "failed_outer_gate_closes_line_permanently": True,
        },
        "v2_reference_actions": {
            "model": "plain_logistic",
            "budget": PRIMARY_BUDGET,
            "threshold": BASELINE_FORENSICS_THRESHOLD,
            "rule": "none",
            "expected_hurt_spans": EXPECTED_V2_REFERENCE_HURT_SPANS,
        },
        "agreement_ensemble": {
            "member_order": list(AGREEMENT_MEMBER_NAMES),
            "full_logistic": {
            ...
            "bootstrap_logistics": {
                ...
                "unit": "case_id_with_all_segments_per_draw",
                "length_weighted": True,
            },
            "mlp256": {
            ...
            "consensus": {
                "proposal": "modal_member_argmax",
                "tie_break": ["largest_seven_member_mean_probability", "lower_class_id"],
                "mean_probability_scope": "all_seven_members",
            },
        },
        "mechanism_gate": {
            "agreement_k_candidates": list(AGREEMENT_K_CANDIDATES),
            "threshold_candidates": list(TAU_CANDIDATES),
            "reference_action_veto": "actual_deployment_abstention_on_reference_span",
            "alternate_qualifying_consensus_is_not_a_veto": True,
            "minimum_harmful_to_helpful_veto_ratio": MECHANISM_MINIMUM_VETO_RATIO,
            "zero_helpful_positive_harmful_is_infinite": True,
            "zero_over_zero_fails": True,
            "must_pass_before_fold_selection": True,
        },
        "fold_selection": {
            "budget": PRIMARY_BUDGET,
            "agreement_k_candidates": list(AGREEMENT_K_CANDIDATES),
    ...
    runner = WORKSPACE_ROOT / "scripts" / "breakfast_visual_repair_head_v3" / "run_oof_screening.py"
