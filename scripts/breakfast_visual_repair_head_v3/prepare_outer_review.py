#!/usr/bin/env python3
"""Prepare the separately reviewed, final single-shot outer evaluation for v3."""
...
def prepare(args: argparse.Namespace) -> Path:
    ...
    if not complete.get("mechanism_gate_pass") or not frozen["mechanism_gate"]["pass"]:
    ...
    runner = WORKSPACE_ROOT / "scripts" / "breakfast_visual_repair_head_v3" / "run_outer_evaluation.py"
    _write_executable(
