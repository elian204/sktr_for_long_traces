#!/usr/bin/env python3
"""Immutable contracts for the final Breakfast agreement-repair study."""
...
PROTOCOL_VERSION = "breakfast-visual-repair-head-v3"
PRIMARY_BUDGET = 0.05
...
AGREEMENT_K_CANDIDATES = (4, 5, 6, 7)
AGREEMENT_MEMBER_NAMES = (
    "full_logistic",
    "bootstrap_logistic_seed_101",
    "bootstrap_logistic_seed_202",
    "bootstrap_logistic_seed_303",
    "mlp256_seed_0",
    "mlp256_seed_1",
    "mlp256_seed_2",
)
...
MECHANISM_MINIMUM_VETO_RATIO = 2.0
EXPECTED_V2_REFERENCE_HURT_SPANS = 13
...
DEFAULT_OOF_STUDY = Path(
    "/data1/eli-bogdanov/sktr_runs/breakfast_visual_repair_head_agreement_oof_v3"
)
DEFAULT_OUTER_REVIEW_STUDY = Path(
    "/home/dsi/eli-bogdanov/breakfast_visual_repair_head_v3_outer_review_v1"
)

SOURCE_FILES = (
    "scripts/breakfast_visual_repair_head_v3/README.md",
    "scripts/breakfast_visual_repair_head_v3/common.py",
    "scripts/breakfast_visual_repair_head_v3/core.py",
    "scripts/breakfast_visual_repair_head_v3/prepare_study.py",
    "scripts/breakfast_visual_repair_head_v3/run_oof_screening.py",
    "scripts/breakfast_visual_repair_head_v3/prepare_outer_review.py",
    "scripts/breakfast_visual_repair_head_v3/record_outer_approval.py",
    "scripts/breakfast_visual_repair_head_v3/run_outer_evaluation.py",
