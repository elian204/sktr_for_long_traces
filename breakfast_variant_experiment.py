...
# --- Case Selection ---
CASE_IDS = [649, 357, 542, 834, 1006, 385, 243, 553, 48, 841, 877, 321, 226, 670]
...
N_DATASET_WORKERS = 8  # Workers for dataset parallelization
...
if __name__ == '__main__':
    ...
    print(hp_summary_df[['alpha', 'strategy', 'sktr_acc', 'argmax_acc', 'sktr_edit', 'argmax_edit', 'sktr_f1@25', 'argmax_f1@25']].to_string())
    ...
    print(f"Saved plot: {hp_results_dir / f'{dataset_name}_hp_search_plots.png'}")
    plt.close()
    ...
    print(sweep_summary_df[['n_train', 'n_variants', 'sktr_acc', 'argmax_acc', 'sktr_edit', 'argmax_edit', 'sktr_f1@25', 'argmax_f1@25']].to_string())
    ...
    plt.suptitle(f'Training Sweep (α={FINAL_ALPHA}, {FINAL_STRATEGY})', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig(final_results_dir / f'{dataset_name}_sweep_plots.png', dpi=150)
    print(f"Saved plot: {final_results_dir / f'{dataset_name}_sweep_plots.png'}")
    plt.close()
